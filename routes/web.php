...
Route::get('/customer/products/{categoryId}', [CustomerOrderController::class, 'getProductsByCategory']);
Route::get('/customer/order/success/{transactionId}', [CustomerOrderController::class, 'orderSuccess'])->name('customer.order.success');
